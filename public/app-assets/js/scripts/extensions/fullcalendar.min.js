...
$(document).ready(function() {
    $("#fc-default").fullCalendar({
        ...
        eventLimit: !0,
        events: [{
            title: "10:30 AM\nxyz service schedule\nof user abc with employee\npqr",
            start: "2019-10-20"
        }, {
            title: "10:30 AM\nxyz service schedule\nof user abc with employee\npqr",
            start: "2019-10-21"
        ...
        select: function(start, end) {
            var eventData, title = prompt("Event Title:");
            title && (eventData = {
                title: title,
                start: start,
                end: end
            }, $("#fc-selectable").fullCalendar("renderEvent", eventData, !0)), $("#fc-selectable").fullCalendar("unselect")
        },
        editable: !0,
        eventLimit: !0,
        events: [{
        ...
        eventClick: function(event) {
            return window.open(event.url, "gcalevent", "width=700,height=600"), !1
        },
    ...
    $("#fc-languages").fullCalendar({
        ...
        $("#lang-selector").append($("<option/>").attr("value", langCode).prop("selected", langCode == initialLangCode).text(langCode))
    }), $("#lang-selector").on("change", function() {
        this.value && $("#fc-languages").fullCalendar("option", "lang", this.value)
        ...
        eventRender: function(event, el) {
            event.start.hasZone() && el.find(".fc-title").after($('<div class="tzo"/>').text(event.start.format("Z")))
        },
        dayClick: function(date) {},
        select: function(startDate, endDate) {}
    }), $.getJSON("app-assets/data/fullcalendar/php/get-timezones.php", function(timezones) {
        $.each(timezones, function(i, timezone) {
            "UTC" != timezone && $("#timezone-selector").append($("<option/>").text(timezone).attr("value", timezone))
        })
