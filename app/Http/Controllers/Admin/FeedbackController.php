...
class FeedbackController extends Controller
{
    ...
    {
        return response()->json(["feedbacks"=>$feedback->fill($request->only($feedback->getFillable()))->save()],200);
    ...
    public function show(Request $request)
    {
        ...
        return response()->json(["feedback"=>Feedback::find($request->id)->with('user')->get()],200);
    }
    ...
    {
        return response()->json(["status"=>Feedback::find($request->id)->delete()],200);
    }
}
