                                ...
                                <div class="row mt-2">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div
                                            class="col-xl-4 col-lg-4 col-md-6 col-sm-6 form-group"
                                        >
                                            <label for="">Recurrent Type</label>
                                            <input
                                                v-model="packageData.recurrency"
                                                type="text"
                                                name=""
                                                placeholder="Abc"
                                                id=""
                                    ...
                                    >
                                        <label for=""
                                            >Status:
                                            {{ packageData.status }}</label
                                        >
                                    </div>
                                </div>
                                <button @click="editPackage" class="button">
                                    Update Package
                                </button>
                            </div>
        ...
        editPackage() {
            axios
                .put("/api/admin/package", {
                    ...
                    recurrency: this.packageData.recurrency
                })
                .then(res => {
